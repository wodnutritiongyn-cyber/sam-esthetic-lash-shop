  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-4 mt-4 animate-fade-in">
        <div className="flex items-center gap-3 bg-card rounded-2xl px-4 py-3.5 border border-border/60 shadow-card focus-within:shadow-elevated focus-within:border-primary/30 transition-all duration-300">
